...
class UserAdmin(DjangoUserAdmin):
    ...
    fieldsets = (
        ...
        (_('Permissions'), {'fields': ('is_active', 'is_staff', 'is_superuser', 'is_business', 'is_uploadable',
    ...
    list_display = ('email', 'first_name', 'last_name', 'is_staff', 'is_business', 'is_uploadable', 'created_at', 'last_login')
    search_fields = ('email', 'first_name', 'last_name')
    list_filter = (
        StaffFilter, ('is_business', BooleanFieldListFilter), ('is_uploadable', BooleanFieldListFilter),
