...
cp ${SCRIPTDIR}/account/dist/apoweroftrance-account-${VERSION}.tar.gz ${SCRIPTDIR}/backend/
...
#python3 -m pip install ${SCRIPTDIR}/backend/apoweroftrance-account-${VERSION}.tar.gz
