...
# A python module for getting statistics from an Icecast server.
# It requires python-requests to make HTTP requests to the server,
# and Element Tree to parse the XML returned.
#
# Example usage:
#
